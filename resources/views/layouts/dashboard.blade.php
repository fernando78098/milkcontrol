			...
			<ul class="nav navbar-nav side-nav nicescroll-bar">
					...
					<li>
						<div class="user-profile text-center">
							<img src="../img/userimgs/{{Auth::user()->name}}.png" alt="user_auth" class="user-auth-img img-circle"/>
				...
				<li>
					...
					<ul id="ecom_dr" class="collapse collapse-level-1">
						...
						<li>
							<a href="{{ route('resultado') }}">Resultado</a>
						</li>
						<li>
                ...
                <li>
					<a href="javascript:void(0);" data-toggle="collapse" data-target="#ui_dr"><div class="pull-left"><i class="zmdi zmdi-smartphone-setup mr-20"></i><span class="right-nav-text">Tratamento Mastite</span></div><div class="pull-right"><i class="zmdi zmdi-caret-down"></i></div><div class="clearfix"></div></a>
					<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
						<li>
							<a href="{{ action('ProcedimentoController@create') }}">Tratamento Celular</a>
						</li>
						<li>
							<a href="modals.html">Tratamento Imprimir</a>
						</li>
